IF(WIN32)
	SET(SQUID_GUI_BUILD_WIN32 1)
ELSE(WIN32)
	IF(APPLE)
		SET(SQUID_GUI_BUILD_APPLE 1)
	ELSE(APPLE)
		SET(SQUID_GUI_BUILD_LINUX 1)
	ENDIF(APPLE)
ENDIF(WIN32)

SET(SQUID_GUI_HOST_X86 FALSE)
SET(SQUID_GUI_HOST_X86_64 FALSE)
...
IF(WIN32)
	IF(WIN64)
		SET(IS_X86_64 TRUE)
		SET(SQUID_GUI_BUILD_WIN64 TRUE)
	ELSE(WIN64)
		SET(IS_X86 TRUE)
	ENDIF(WIN64)
ENDIF(WIN32)
...
IF(IS_X86)
	SET(SQUID_GUI_HOST_X86 TRUE)
ELSEIF(IS_X86_64)
	SET(SQUID_GUI_HOST_X86_64 TRUE)
ELSE(IS_X86)
